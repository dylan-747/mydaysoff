...
- Live-source mode caps can be tuned with `LIVE_MAX_TOTAL`, `LIVE_PER_DAY_LIMIT`, `LIVE_PER_DAY_CITY_LIMIT`, `LIVE_PER_DAY_CATEGORY_LIMIT`, `LIVE_CITY_TOTAL_LIMIT`, `LIVE_SOURCE_CITY_TOTAL_LIMIT`.
